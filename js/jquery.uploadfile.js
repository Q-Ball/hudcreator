...
//            var fileUploadId = "ajax-upload-id-" + (new Date().getTime());
            var fileUploadId = "ajax-upload-id-" + obj.selector.replace("#","");
...
//			fileInput.css({"background" : "none","border" : "none","box-shadow" : "none","padding" : "0px"});
/*			fileInput.css({position: 'absolute','cursor':'pointer',  
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='ajax-file-upload-statusbar' style='display:none;'></div>");
